...
final class ModelData: ObservableObject
{
    ...
    func addToCart(product: Product)
    {
        ...
        TCServerSideImplementation.sendAddToCartEvent(product: product)
    }
    
    func toggleProductIsFavorite(product: Product)
    {
        TCServerSideImplementation.sendAddToWishListEvent(product: product)
    ...
    func setShippingInfo(adress:String)
    {
        ...
        TCServerSideImplementation.sendAddShippingInfo(adress: adress)
    }
    ...
    func setPaiementInfo(cardNumber: String, fullName: String)
    {
        ...
        TCServerSideImplementation.sendAddPaiementInfo(method: "card", coupon: order.coupon, product: order.product)
    }
    
    func removeFromCart(product: Product)
    {
        toggleProductInCart(productID: product.id)
        TCServerSideImplementation.sendRemoveFromCartEvent(product: product)
    }
    ...
    func setCartInfo(totalAmount:Int, coupon: String, product:Product)
    {
        ...
        TCServerSideImplementation.sendBeginCheckoutEvent()
    }
}
